      ...
      <div className="min-w-0 flex-1">
        ...
        {onRetry && (
          <button
            type="button"
            onClick={onRetry}
            className="mt-3 inline-flex items-center gap-2 rounded-md border border-red-200 bg-white px-3 py-1.5 text-xs font-medium text-red-700 transition hover:bg-red-100"
          >
            <RefreshCw size={12} />
            Retry
          </button>
...
export const EmptyState: React.FC<{
  ...
  <div className="rounded-lg border border-dashed border-stone-300 bg-white py-12 text-center text-stone-500">
...
export const ResourceMeta: React.FC<{
  ...
  return (
    <span
      role="status"
      aria-live="polite"
      className={`text-xs ${stale ? 'text-amber-600' : 'text-stone-400'}`}
    >
