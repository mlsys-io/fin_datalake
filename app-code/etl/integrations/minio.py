"""
MinIO service helpers for storage bucket management.

These helpers are used for infrastructure setup operations like creating
and deleting buckets, separate from ETL pipeline logic.
"""
import os
