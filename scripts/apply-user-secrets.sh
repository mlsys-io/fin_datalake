...
RAY_KEYS=(
  "${COMMON_LLM_KEYS[@]}"
  FMP_API_KEY
  DEMO_MARKET_DATA_PROVIDER
  DEMO_SYMBOL
  DEMO_PRICE_WINDOW_SIZE
  DEMO_PRICE_SERVICE_NAME
  DEMO_PRICE_WEBSOCKET_URL
  DEMO_PRICE_WINDOW_CONTEXT_KEY
  DEMO_PRICE_META_CONTEXT_KEY
  DEMO_PRICE_METRICS_CONTEXT_KEY
  DEMO_PRICE_SERVICE_READY_TIMEOUT_SECONDS
  DEMO_MARKET_ANALYST_AGENT_NAME
  DEMO_STRATEGY_AGENT_NAME
  DEMO_RISINGWAVE_PRICE_TABLE
  DEMO_RISINGWAVE_SIGNAL_TABLE
  RISINGWAVE_USER
  RISINGWAVE_PASSWORD
  RISINGWAVE_DATABASE
  RISINGWAVE_SCHEMA
